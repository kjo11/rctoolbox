...
disp('SISO, continuous, unstable, yalmip')
...
opt=condesopt('gamma',[0.2 1.8 0.001],'lambda',[1 1 0 0],'nq',[],'yalmip','on');
opt2=condesopt('gamma',[0.2 1.8 0.001],'lambda',[1 1 0 0],'nq',30,'yalmip','off');
