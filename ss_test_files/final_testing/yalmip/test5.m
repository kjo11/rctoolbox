...
disp('MIMO (2x1), continuous, yalmip')
...
options1 = condesopt ('lambda',[1 1 0 0],'gamma',[0.5,2,0.01],'gbands','off','yalmip','on','nq',[]);
options2 = condesopt ('lambda',[1 1 0 0],'gamma',[0.5,2,0.01],'gbands','off','yalmip','off');
